...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'rooms_app/static'),
]

STATIC_ROOT = os.path.join(BASE_DIR, 'rooms_app/staticfiles')
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'hyperjuniorxd@gmail.com'
EMAIL_HOST_PASSWORD = 'ooss uegv pkxx mvfd'